...
#define D25     (IO_MAKE_PIN(PORTC_INDEX,  9)) //???
#define D26     (IO_MAKE_PIN(PORTC_INDEX,  6))
#define D27     (IO_MAKE_PIN(PORTC_INDEX,  7))
#define D28     (IO_MAKE_PIN(PORTC_INDEX, 10))
#define D29     (IO_MAKE_PIN(PORTD_INDEX,  0))
#define D30     (IO_MAKE_PIN(PORTC_INDEX, 11))
...
#define A08     (IO_MAKE_PIN_ANALOG(PORTC_INDEX, 10, 6, ANALOG_1, ANALOG_MUX_B))
#define A09     (IO_MAKE_PIN_ANALOG(PORT_INVALID, PIN_INVALID, 0, ANALOG_0, ANALOG_MUX_A))
...
#define SPI0_SOUT_D26   IO_MAKE_PIN_MUX(PORTC_INDEX, 6, PORT_MUX_ALT2)
#define SPI0_SIN_D14    IO_MAKE_PIN_MUX(PORTD_INDEX, 3, PORT_MUX_ALT2)
#define SPI0_SIN_D27    IO_MAKE_PIN_MUX(PORTC_INDEX, 7, PORT_MUX_ALT2)

#define SPI0_CS_D29     IO_MAKE_PIN_SPI_CS(PORTD_INDEX, 0, PORT_MUX_ALT2, 0)
...
#define D26_WAKE_RISING         WAKEUP_INPUT_10_RISING
#define D26_WAKE_FALLING        WAKEUP_INPUT_10_FALLING
#define D29_WAKE_RISING         WAKEUP_INPUT_12_RISING
#define D29_WAKE_FALLING        WAKEUP_INPUT_12_FALLING
#define D30_WAKE_RISING         WAKEUP_INPUT_11_RISING
#define D30_WAKE_FALLING        WAKEUP_INPUT_11_FALLING
